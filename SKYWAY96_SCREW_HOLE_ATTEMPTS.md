...
- `SKYWAVE96_RULES.md` — Unified generation rules (Claude ↔ Gemini)
- `SKYWAVE96_DXF_RULES.md` — Detailed dimension specs
- `SKYWAVE96_INKSCAPE_SCREW_HOLES.md` — Manual placement guide
